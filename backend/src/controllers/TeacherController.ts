...
export class TeacherController {
  ...
  update = async (req: AuthRequest, res: Response): Promise<Response> => {
    ...
    try {
      ...
      if (titulation) teacher.titulation = titulation;
      if (formation) teacher.formation = formation;
  ...
  assignToDiscipline = async (req: AuthRequest, res: Response): Promise<Response> => {
    try {
      const { id } = req.params;
